...
<div id="payment" class="woocommerce-checkout-payment">
    ...
    <div class="form-row place-order">
        ...
        <div class="my-custom-checkout-extra">
            <p class="text-danger fw-bold">Note: We have not yet applied delivery charges. We will calculate and confirm
                the
                final amount with you before payment.</p>
