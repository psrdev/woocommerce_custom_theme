...
if ($top_products->have_posts()):
    ?>
    <section class="top-products-slider py-5">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="section-title mb-0">Top 10 Products</h2>
                <div class="swiper-nav d-none d-md-flex">
                    <button class="swiper-button-prev btn btn-light btn-sm rounded-circle"><i
                            class="bi bi-chevron-left"></i></button>
                    <button class="swiper-button-next btn btn-light btn-sm rounded-circle"><i
